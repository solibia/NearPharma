...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    private long UPDATE_INTERVAL = 2 * 10000;  /* 100 secs */
    ...
    private String apiPath = "http://localhost/phpapi/phpmysqlpiforandroid/mobile/list/"; //Path de l'api
    ...
    private class ServiceStubAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            com.example.parsaniahardik.phprestapp.HttpConnectionService service = new com.example.parsaniahardik.phprestapp.HttpConnectionService();
        ...
        protected void onPostExecute(Void result) {
            ...
            if (success == 1) {
                if (null != restulJsonArray) {
                    mMap.clear();
                    for (int i = 0; i < restulJsonArray.length(); i++) {//Affichage des pharmacies
                        try {
                            JSONObject jsonObject = restulJsonArray.getJSONObject(i);
                            BitmapDescriptor bitmapMarker = BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN);
                            mMap.addMarker(new MarkerOptions().position(new LatLng(jsonObject.getDouble("lat"),
                                    jsonObject.getDouble("lng"))).title(jsonObject.
                                    getString("nompharma")).snippet("and snippet").icon(bitmapMarker));
